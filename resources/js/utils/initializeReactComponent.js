...
export function initializeReactComponent(rootId, Component, FallbackComponent, retryDelay = 200) {
        ...
        setTimeout(() => {
            ...
            try {
                ...
                try {
                    ...
                    console.log(`Successfully rendered ${Component.name} to #${rootId}`);
                } catch (componentError) {
                    console.error(`Error rendering ${Component.name}:`, componentError);
                ...
                renderErrorMessage(document.getElementById(rootId));
            }
        }, retryDelay);
    }
